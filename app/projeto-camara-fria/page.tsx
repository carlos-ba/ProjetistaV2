      ...
      <main>
        ...
        <section className="section pricing-section" id="planos">
          ...
          <div className="pricing-grid">
            ...
            <article className="price-card"><p className="plan-name">Profissional Semestral</p><div className="price"><strong>6 × R$ 99</strong><span>total de R$ 594</span></div><ul><li>Plataforma completa por 6 meses</li><li>Projetos ilimitados*</li><li>Lives técnicas</li><li>1 validação técnica por mês</li><li>Suporte via WhatsApp</li></ul><a className="button ghost full" href="/contratar/semestral">Simular plano semestral</a></article>
